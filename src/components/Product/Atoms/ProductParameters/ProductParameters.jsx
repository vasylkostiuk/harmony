    ...
    return (
        <div className={styles.container}>
            <div className={styles.item}>
                ...
                <p className={styles.text}> Area: {area}</p>
            </div>
            <div className={styles.item}>
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className={styles.text}> Diameter: {diameter}</p>
            </div>
            <div className={styles.item}>
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className={styles.text}> Maximum Height: {maxHeight}</p>
            </div>
            <div className={styles.item}>
                <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className={styles.text}> Weight: {weight}</p>
            </div>
        </div>
    );
}
